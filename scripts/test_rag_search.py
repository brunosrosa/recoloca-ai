...
try:
    ...
    from core_logic.constants import FAISS_INDEX_DIR
except ImportError as e:
    print(f"❌ Erro ao importar módulos: {e}")
    print(f"Paths tentados: {sys.path[:3]}")
    sys.exit(1)
...
def test_rag_search():
    ...
    try:
        print("🔍 Teste Final do Sistema RAG")
        print("=" * 40)
        ...
        for i, query in enumerate(test_queries, 1):
            ...
            try:
                ...
                if results:
                    ...
                    print(f"    ✅ {len(results)} resultados em {search_time:.3f}s")
                    ...
                    print(f"    📄 Primeiro resultado (score: {first_result['score']:.3f}): {content_preview}")
                else:
                    print(f"    ❌ Nenhum resultado em {search_time:.3f}s")
        ...
        if success_rate >= 50 and avg_time <= 1.0:
            ...
            print("\n🔧 Sistema RAG precisa de ajustes.")
            return False
...
def main():
    ...
    if success:
        ...
        print("\n🚀 O sistema RAG está pronto para uso.")
    else:
        print("\n❌ Teste falhou.")
        print("\n💡 Sugestões:")
