...
class RAGSystemDemo:
    ...
    def demo_backend_detection(self):
        ...
        logger.info("🔍 === DEMONSTRAÇÃO: DETECÇÃO DE BACKEND ===")
        
        retriever = RAGRetriever()
        backend_info = retriever.get_backend_info()
        
        logger.info("📊 Informações do Backend:")
    ...
    def demo_pytorch_gpu_retriever(self):
        ...
        logger.info("\n🚀 === DEMONSTRAÇÃO: PYTORCH GPU RETRIEVER ===")
        ...
        logger.info(f"   Inicialização: {'✅ Sucesso' if init_success else '❌ Falhou'}")
        
        # Mostrar informações
        index_info = retriever.get_index_info()
        logger.info("📋 Informações do Índice:")
    ...
    def demo_optimized_retriever(self):
        ...
        logger.info("\n⚡ === DEMONSTRAÇÃO: OPTIMIZED PYTORCH RETRIEVER ===")
        ...
        # Inicializar
        logger.info("🔧 Inicializando retriever otimizado...")
        init_success = retriever.initialize()
        logger.info(f"   Inicialização: {'✅ Sucesso' if init_success else '❌ Falhou'}")
        ...
        stats = retriever.get_stats()
        logger.info("📊 Estatísticas Completas:")
    ...
    def demo_rag_retriever_configurations(self):
        ...
        logger.info("\n🔗 === DEMONSTRAÇÃO: CONFIGURAÇÕES RAG RETRIEVER ===")
        ...
        for config in configurations:
            ...
            try:
                ...
                logger.info(f"   ✅ Backend: {backend_info.get('current_backend', 'N/A')}")
                logger.info(f"   📊 Status: {index_info.get('status', 'N/A')}")
    ...
    def demo_performance_comparison(self):
        ...
        if not torch.cuda.is_available():
            logger.warning("⚠️ GPU não disponível. Pulando teste de performance.")
            return
    ...
    def demo_memory_usage(self):
        ...
        logger.info("\n💾 === DEMONSTRAÇÃO: MONITORAMENTO DE MEMÓRIA ===")
        ...
        try:
            ...
            logger.info("\n⚠️ psutil não disponível para monitoramento de memória do sistema")
    
    def demo_best_practices(self):
        """Demonstra melhores práticas de uso."""
        logger.info("\n💡 === DEMONSTRAÇÃO: MELHORES PRÁTICAS ===")
    ...
    def run_complete_demo(self):
        ...
        logger.info("🎯 INICIANDO DEMONSTRAÇÃO COMPLETA DO SISTEMA RAG")
        logger.info("=" * 70)
        ...
        try:
            ...
            logger.info("   ✅ Detecção automática de backend")
            logger.info("   ✅ PyTorch GPU Retriever")
            logger.info("   ✅ Optimized Retriever com cache")
            logger.info("   ✅ Múltiplas configurações RAG")
            logger.info("   ✅ Comparação de performance")
            logger.info("   ✅ Monitoramento de memória")
            logger.info("   ✅ Melhores práticas de uso")
            
            logger.info("\n🚀 O sistema RAG está pronto para produção!")
