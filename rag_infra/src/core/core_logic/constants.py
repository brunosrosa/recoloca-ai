...
RAG_ROOT_DIR = Path(__file__).parent.parent.parent.parent  # rag_infra/

# Diretórios de dados
SOURCE_DOCUMENTS_DIR = RAG_ROOT_DIR / "data" / "source_documents"
...
STATUS_MESSAGES = {
    ...
    "gpu_unavailable": "⚠️ GPU não disponível, usando CPU",
