...
class RAGIntegrationTester:
    ...
    def test_backend_detection(self) -> Dict[str, Any]:
        ...
        """
        logger.info("🔍 Testando detecção automática de backend...")
        ...
        try:
            ...
            logger.info("✅ Detecção de backend testada com sucesso")
            return results
    ...
    def test_initialization_performance(self) -> Dict[str, Any]:
        ...
        """
        logger.info("⚡ Testando performance de inicialização...")
        ...
        logger.info("✅ Performance de inicialização testada")
        return results
    ...
    def test_search_performance(self, backend: str = "auto") -> Dict[str, Any]:
        ...
        Returns:
            Dict: Métricas de performance
        """
        logger.info(f"🔍 Testando performance de busca ({backend})...")
        ...
        logger.info(f"✅ Performance testada: {results['average_time']:.3f}s média")
        return results
    ...
    def test_concurrent_queries(self, backend: str = "auto", max_workers: int = 5) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🚀 Testando consultas concorrentes ({backend}, {max_workers} workers)...")
        ...
        logger.info(f"✅ Concorrência testada: {results['queries_per_second']:.2f} queries/s")
        return results
    ...
    def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"❌ Erro na bateria de testes: {e}")
