...
from rag_infra.core_logic.rag_metrics_monitor import metrics_collector, start_monitoring
...
def get_metrics_dashboard() -> Dict[str, Any]:
    ...
    """
    from rag_infra.core_logic.rag_metrics_monitor import get_metrics_dashboard
