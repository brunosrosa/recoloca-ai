**(Mentor de Conteúdo Educacional e Onboarding):** 
Ensinar os usuários (ex: como melhorar o currículo, se preparar para entrevistas), este agente ajudaria a estruturar e refinar esse conteúdo.
...
- RAG Recoloca.ai (acesso à "Documentação Viva" e bases de conhecimento específicas)
