**(Mentor de Suporte ao Usuário e Comunidade):** Para ajudar a definir estratégias de atendimento, FAQs, e gestão de comunidade conforme a base de usuários cresce.
